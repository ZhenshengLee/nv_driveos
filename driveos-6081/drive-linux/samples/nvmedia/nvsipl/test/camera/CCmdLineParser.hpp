...
class CCmdLineParser
{
 public:
    ...
    static void ShowUsage(void)
    {
        ...
        cout << "-b or --enableAuth                         :Forcefully enable authentication for all camera sensors\n";
    ...
    {
        const char *const short_options = "hc:m:nr:v:t:lR012sMP:aCk:N:O:eIoLi:Sf:K:W:T:D:U:bF:"
#ifdef NVMEDIA_QNX
                                          "7"
#endif //NVMEDIA_QNX
#if !NV_IS_SAFETY
