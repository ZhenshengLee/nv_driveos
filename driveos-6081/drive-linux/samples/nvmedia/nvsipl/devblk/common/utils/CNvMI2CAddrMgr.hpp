...
public:
    ...
    /**
     * @brief Prevent CNvMI2CAddrMgr from being move constructed.
     */
    CNvMI2CAddrMgr(CNvMI2CAddrMgr&&) = delete;
    ...
    /**
     * @brief Prevent CNvMI2CAddrMgr from being move assigned.
     */
    CNvMI2CAddrMgr& operator=(CNvMI2CAddrMgr&&) = delete;
