...
class CNvMMax20087SyncAdapter : public CNvMCampwr
{
  public:
    ...
    SIPLStatus SetConfig(uint8_t i2cAddress,
                const DeviceParams *const params) override;
    ...
    SIPLStatus CreatePowerDevice(DevBlkCDIRootDevice* const cdiRoot,
                const uint8_t linkIndex) override;
    ...
    SIPLStatus WriteRegister(DevBlkCDIDevice const * const handle,
               ...
               const uint8_t * const dataBuff) override;
