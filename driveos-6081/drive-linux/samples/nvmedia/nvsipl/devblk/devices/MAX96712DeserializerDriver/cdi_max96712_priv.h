...
typedef enum {
    ...
    REG_FIELD_MODE_DT_PHY0,
    REG_FIELD_MODE_DT_PHY1,
    REG_FIELD_MODE_DT_PHY2,
    REG_FIELD_MODE_DT_PHY3,
    REG_FIELD_ALT2_MEM_MAP8_PHY0,
    REG_FIELD_ALT2_MEM_MAP8_PHY1,
    REG_FIELD_ALT2_MEM_MAP8_PHY2,
    REG_FIELD_ALT2_MEM_MAP8_PHY3,

    REG_FIELD_MODE_DT_PIPE4,
    REG_FIELD_MODE_DT_PIPE5,
    REG_FIELD_MODE_DT_PIPE6,
    REG_FIELD_MODE_DT_PIPE7,
...
static const RegBitFieldProp regBitFieldProps[REG_FIELD_MAX] = {
    ...
    [REG_FIELD_MODE_DT_PHY0]             = {.regAddr = 0x0933, .msbPos = 3, .lsbPos = 3},
    [REG_FIELD_MODE_DT_PHY1]             = {.regAddr = 0x0973, .msbPos = 3, .lsbPos = 3},
    [REG_FIELD_MODE_DT_PHY2]             = {.regAddr = 0x09B3, .msbPos = 3, .lsbPos = 3},
    [REG_FIELD_MODE_DT_PHY3]             = {.regAddr = 0x09F3, .msbPos = 3, .lsbPos = 3},
    ...
    [REG_FIELD_MODE_DT_PIPE4]            = {.regAddr = 0x0A31, .msbPos = 3, .lsbPos = 3},
    [REG_FIELD_MODE_DT_PIPE5]            = {.regAddr = 0x0A71, .msbPos = 3, .lsbPos = 3},
    [REG_FIELD_MODE_DT_PIPE6]            = {.regAddr = 0x0AB1, .msbPos = 3, .lsbPos = 3},
    [REG_FIELD_MODE_DT_PIPE7]            = {.regAddr = 0x0AF1, .msbPos = 3, .lsbPos = 3},
