...
SIPLStatus CNvMMAX96712TPG::EnableLinkAndDetect() {
...
SIPLStatus CNvMMAX96712TPG::Init() {
    ...
    NvSiplCapInputFormatType inputFormatType = m_upCameraModuleProperty->sensorProperties.inputFormat.inputFormatType;
    ...
    if (m_initLinkMask != 0) {
        ...
        paramsMAX96712.SetPGSetting.width = m_upCameraModuleProperty->sensorProperties.width;
        paramsMAX96712.SetPGSetting.height = m_upCameraModuleProperty->sensorProperties.height;
        paramsMAX96712.SetPGSetting.frameRate = m_upCameraModuleProperty->sensorProperties.frameRate;
        ...
        if (inputFormatType == NVSIPL_CAP_INPUT_FORMAT_TYPE_RAW10) {
            dataType = CDI_MAX96712_DATA_TYPE_RAW10;
                   ...
                   (inputFormatType == NVSIPL_CAP_INPUT_FORMAT_TYPE_RAW12RJ)) {
