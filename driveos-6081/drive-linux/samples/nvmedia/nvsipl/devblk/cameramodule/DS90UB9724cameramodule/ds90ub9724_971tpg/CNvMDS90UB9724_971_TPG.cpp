...
namespace nvsipl
{
void CNvMDS90UB9724_971_TPG::SetSensorConnectionProperty(
    ...
    sensorConnectionProperty->frameSync.pinNum = 0U;
    sensorConnectionProperty->refClock.isNeeded = false; /* Default unused: Switched by schematic on image sensor side */
    ...
    sensorConnectionProperty->FPDLinkMode = LINKMODE_FPDLINK4_SYNC;
}
