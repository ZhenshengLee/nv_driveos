...
public:
    ...
    typedef struct {
        ...
        /**
         * Flag indicating whether the Camera Boot Accelerator is enabled or not.
         */
        bool bCBAEnabled;
     ...
     */
    virtual SIPLStatus PostSensorInit(uint8_t const linkMask, bool const groupInitProg) const = 0;
