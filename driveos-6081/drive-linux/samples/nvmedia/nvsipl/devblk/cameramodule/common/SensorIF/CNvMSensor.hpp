...
/* coverity[misra_cpp_2008_rule_16_2_1_violation] : intentional TID-1391 */
    ...
    /**
     * Set image authentication thread ID.
     *
     * @param[in] threadID Thread ID to set. Any value is valid.
     */
    void SetImgAuthThreadID(uint8_t const threadID) noexcept;

    /**
     * Get image authentication thread ID.
     *
     * @retval An ID which should be use for image authentication of the sensor.
     */
    uint8_t GetImgAuthThreadID() const noexcept;
...
/* coverity[misra_cpp_2008_rule_16_2_1_violation] : intentional TID-1391 */
     ...
     */
    NvMediaStatus SIPLParseTopEmbDataInfo(
                   ...
                   size_t const dataInfoStructSize) final;
     ...
     * For details refer ISensorControl interface class.
     */
     NvMediaStatus SIPLParseBotEmbDataInfo(
     ...
     * For details refer ISensorControl interface class.
     */
    NvMediaStatus SIPLSetSensorControls(
                   DevBlkCDISensorControl const* const sensorControl,
                   size_t const sensrCtrlStructSize) final;
     ...
     * For details refer ISensorControl interface class.
     */
    NvMediaStatus SIPLGetSensorAttributes(
                   DevBlkCDISensorAttributes *const sensorAttr,
                   size_t const sensorAttrStructSize) final;
