...
static const DevBlkCDII2CReg ov2311_default_setting[]={
    ...
    { 0x3826, 0x05 }, /* 1448 - 4 = 1444 */
    { 0x3827, 0x8C },

    { 0x3017, 0xF2 }, /* Disable entring into power saving mode. Without this, some registers read back as 0 */
...
static const DevBlkCDII2CReg ov2311_format_30fps[]={
    { 0x380e, 0x0b }, /* VTS = 2848 */
    { 0x380f, 0x20 },
    { 0x3826, 0x0B }, /* 2848 - 4 = 2844 */
    { 0x3827, 0x1C },
};
