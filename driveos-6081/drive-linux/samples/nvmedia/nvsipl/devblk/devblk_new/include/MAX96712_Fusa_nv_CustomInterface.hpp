...
/**
 * @brief Describes the custom error information for VID_SEQ_ERR bits in VIDEO_RX8
 *        registers. Bits 0 to 7 represent VID_SEQ_ERR bits in each of the 8 pipelines.
 *        If bit is set, corresponding flag is set.
 */
typedef struct {
    /**
     * @brief Holds the error information for VID_SEQ_ERR bits in VIDEO_RX8.
     */
