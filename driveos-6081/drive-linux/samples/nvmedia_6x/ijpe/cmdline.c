/*
 * Copyright (c) 2014-2023, NVIDIA CORPORATION.  All rights reserved. All
...
void PrintUsage()
{
    ...
    LOG_MSG("-alternateCreateAPI        Use alternate create API of IJPE element \n");
}
...
int ParseArgs(int argc, char **argv, TestArgs *args)
{
    ...
    for(i = 0; i < argc; i++) {
        ...
        if(argv[i][0] == '-') {
            ...
            else if(strcasecmp(argv[i], "-alternateCreateAPI") == 0) {
