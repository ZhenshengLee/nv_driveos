...
/**
 * enum representing superframe type.
 */
typedef enum
{
    ILM_SUPERFRAME_TYPE_NONE = 0x0,
    ILM_SUPERFRAME_TYPE_SYMMETRIC,
    ILM_SUPERFRAME_TYPE_ASYMMETRIC
} t_ilm_superframe_type;

struct ilmSuperFrameViewInfo
{
    t_ilm_uint index;     /*!< Index of the view */
    t_ilm_uint x;         /*!< StartX of the view */
    t_ilm_uint y;         /*!< StartY of the view */
    t_ilm_uint width;     /*!< Width of the view */
    t_ilm_uint height;    /*!< Height of the view */
};
...
struct ilmScreenProperties
{
    ...
    t_ilm_float refreshRate;        /*!< refresh rate of the display */

    t_ilm_superframe_type superframeType; /*!< superframe type as supported by the screen */
    t_ilm_uint numSuperframeViews; /*!< number of superframe views */
    struct ilmSuperFrameViewInfo *superFrameViewInfo;  /*!< Array of superframe view info */
};
