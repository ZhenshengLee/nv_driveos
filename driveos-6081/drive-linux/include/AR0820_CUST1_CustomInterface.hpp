...
public:
    ...
    AR0820_CUST1_MAX9295_CustomInterface() = default;
    AR0820_CUST1_MAX9295_CustomInterface(AR0820_CUST1_MAX9295_CustomInterface const &) = delete;
    AR0820_CUST1_MAX9295_CustomInterface(AR0820_CUST1_MAX9295_CustomInterface &&) = delete;
    AR0820_CUST1_MAX9295_CustomInterface &operator = (AR0820_CUST1_MAX9295_CustomInterface const &) & = delete;
    AR0820_CUST1_MAX9295_CustomInterface &operator = (AR0820_CUST1_MAX9295_CustomInterface &&) & = delete;
    /**
...
#endif
protected:
    ~AR0820_CUST1_MAX9295_CustomInterface(void) override = default;
};
...
/* coverity[autosar_cpp14_a16_0_1_violation] : intentional TID-2039 */
    ...
    */
     ...
     *
     * @param[out] dataBuff pointer to top of Voltage/Current values
     *             array for each linkIndex.
