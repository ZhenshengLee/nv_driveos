...
class INvSIPLCamera
{
 public:
     ...
     * NvSciBufGeneralAttrKey_PeerHwEngineArray set to following NvSciBufPeerHwEngine value.
     ...
     *
     * This method updates the input NvSciSyncAttrList with values equivalent to the
     * following public attribute key-values:
     * NvSciSyncAttrKey_RequiredPerm set to
     * - NvSciSyncAccessPerm_WaitOnly for @ref clientType SIPL_WAITER
     * - NvSciSyncAccessPerm_SignalOnly for @ref clientType SIPL_SIGNALER
     * NvSciSyncAttrKey_PrimitiveInfo set to
     * - NvSciSyncAttrValPrimitiveType_Syncpoint
     *
     * This interfaces updates the input NvSciBufAttrList with values equivalent to the following
     * public attribute key-values:
     * NvSciSyncAttrKey_PeerHwEngineArray set to following NvSciBufPeerHwEngine value only for
     * OutputType ICP.
     * -  NvSciBufHwEngName set to NvSciBufHwEngName_Vi
     * -  NvSciBufPlatformName set to NvSciBufPlatformName_Orin
     *
     * @pre This function must be called
     * - after @ref SetPipelineCfg on Tegra
     * - after @ref Init() on x86
