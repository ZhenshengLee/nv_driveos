 ...
 * undefined. The user is responsible for destroying the NvSciEventNotifier
 ...
 *
 * The user is responsible for destroying the NvSciEventNotifier and
 *   NvSciEventService when it's no longer needed. The NvSciIpc event notifier
 *   should be deleted before calling NvSciIpcCloseEndpointSafe(),
 *
 * @pre
 * - This API and NvSciStreamBlockEventServiceSetup should be called after
 *   the input block is created and before connecting it to other block.
 *
 * <b>Actions</b>
 ...
 * channel.
 *
 * NOTE: Configure the NvSciIpc channel with enough frames. Otherwise,
