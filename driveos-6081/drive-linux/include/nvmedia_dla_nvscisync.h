 ...
 * the input NvMediaDLA handle using %NvMediaDlaRegisterNvSciSyncObj()
 *  - @a sofnvscisyncobj must have been set as the active SOF NvSciSyncObj.
 ...
 * the input NvMediaDLA handle using NvMediaDlaRegisterNvSciSyncObj().
 *  - @a eofnvscisyncobj must have been set as the active EOF NvSciSyncObj.
 *  - A task must have been submitted to the DLA engine using %NvMediaDlaSubmit().
 *
 * @usage
 * - Allowed context for the API call
 ...
 * before calling a DLA submit API & before NvSciSyncObj gets signaled by DLA
 ...
 * before calling a DLA submit API and before NvSciSyncObj gets signaled by DLA
