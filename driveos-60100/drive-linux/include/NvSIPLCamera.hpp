 ...
 * manage image processing pipelines to receive outputs in @ref NvSciBufObj Images.
 *
 * @ingroup NvSIPL */
...
/**
 * @brief NvSIPLNitoMetadata defines the 3-tuple returned by a successful call
 * to @ref GetNitoMetadataFromMemory().
 */
 ...
 * @param[in,out] metadataArray        An array of @ref NvSIPLNitoMetadata tuples to store the result.
...
{
    /** For a given @ref NvSciSyncObj SIPL acts as a signaler. This type corresponds to
     *  postfences from SIPL
     */
    SIPL_SIGNALER,
    /** For a given @ref NvSciSyncObj SIPL acts as a waiter. This type corresponds to
     *  prefences to SIPL
     */
    SIPL_WAITER
 ...
 */
typedef enum : std::uint8_t {
    /** Specifies an @ref NvSciSyncObj type for which SIPL acts as a waiter. */
    NVSIPL_PRESYNCOBJ,
    /** Specifies an @ref NvSciSyncObj type for which SIPL acts as a signaler, signaling EOFFence. */
    NVSIPL_EOFSYNCOBJ
 ...
 *
 * A SIPL client acquires this API by calling @ref GetInstance() exactly once.
 *
 */
class INvSIPLCamera
{
 public:
     ...
     * @pre None.
     *
     * @returns a pointer to a new @ref INvSIPLCamera instance.
     *
     * @usage
     * - Allowed context for the API call
     *   - Interrupt handler: No
     ...
     * @pre None.
     *
     * @param[in] platformConfig @ref PlatformCfg - The external devices referenced in the platform
     *                           configuration must be supported by the SIPL Device Block drivers.
     ...
     *   - De-Init: No
     */
    virtual SIPLStatus SetPipelineCfg(uint32_t const index,
     ...
     * @param[in] autoControl Handle to plugin implementation, or nullptr if type is NV_PLUGIN.
     * @param[in] blob        Reference to binary blob containing the sensor and ISP calibration data
     *
     * @returns::SIPLStatus the completion status of the operation.
     *
     * @usage
     ...
     *   - De-Init: No
     */
    virtual SIPLStatus RegisterAutoControlPlugin(uint32_t const index,
                                                 PluginType type,
     ...
     * allocate the images.
     *
     * This interfaces updates the input @ref NvSciBufAttrList with values equivalent to the following
     * public attribute key-values:
     * @ref NvSciBufGeneralAttrKey_PeerHwEngineArray set to following @ref NvSciBufPeerHwEngine value.
     * -  @ref NvSciBufHwEngName set to
     *     - @ref NvSciBufHwEngName_Vi for OutputType ICP
     *     - @ref NvSciBufHwEngName_Csi for OutputType ICP
     *     - @ref NvSciBufHwEngName_Isp for OutputType ICP, ISP0, ISP1 or ISP2
     * -  @ref NvSciBufPlatformName set to @ref NvSciBufPlatformName_Orin
     *
     * @pre This function must be called after @ref SetPipelineCfg()
     * but before @ref RegisterImages() for the specific output type
     *
     * @param[in] index The ID of the sensor.
     ...
     *
     * @attention The surface type for ICP output is determined by the properties of the image sensor
     * and must not be pre-filled by the user
     *
     ...
     * @ref NvSciBufImageAttrKey_SurfType set to @ref NvSciSurfType_YUV
     * @ref NvSciBufImageAttrKey_SurfBPC set to @ref NvSciSurfBPC_8
     * @ref NvSciBufImageAttrKey_SurfMemLayout set to @ref NvSciSurfMemLayout_SemiPlanar
     * @ref NvSciBufImageAttrKey_SurfSampleType set to @ref NvSciSurfSampleType_420
     * @ref NvSciBufImageAttrKey_SurfComponentOrder set to @ref NvSciSurfComponentOrder_YUV
     * @ref NvSciBufImageAttrKey_SurfColorStd set to @ref NvSciColorStd_REC709_ER
     * @ref NvSciBufImageAttrKey_Layout set to @ref NvSciBufImage_BlockLinearType
     *
     * @li The surface type for ISP1 output is set to the following by default if not
     * already set by the client.
     * @note if set by client it must only be to one of the supported
     ...
     * @ref NvSciBufImageAttrKey_PlaneCount set to 1U
     * @ref NvSciBufImageAttrKey_PlaneColorFormat set with @ref NvSciColor_Y16
     * @ref NvSciBufImageAttrKey_PlaneColorStd set to @ref NvSciColorStd_REC709_ER
     * @ref NvSciBufImageAttrKey_Layout set to @ref NvSciBufImage_PitchLinearType
     *
     * @li The surface type for ISP2 output is set to the
     * following by default if not already set by the client.
     *
     * @note if set by client it must only be to one of the supported surface types of ISP output
     * listed in @ref RegisterImages or an error will be generated.
     ...
     * @ref NvSciBufImageAttrKey_PlaneCount set to 1U
     * @ref NvSciBufImageAttrKey_PlaneColorFormat set with @ref NvSciColor_Float_A16
     * @ref NvSciBufImageAttrKey_PlaneColorStd set to @ref NvSciColorStd_SENSOR_RGBA
     * @ref NvSciBufImageAttrKey_Layout set to @ref NvSciBufImage_PitchLinearType
     *
     * @returns::SIPLStatus the completion status of the operation.
     *
     ...
     *   - De-Init: No
     */
    virtual SIPLStatus GetImageAttributes(uint32_t const index,
     ...
     *
     * @pre This function must be called after @ref Init() and before @ref Start(). ICP output images
     * must be registered before ISP output images. Additionally, if ISP output is enabled, images for
     * ISP outputs must be registered before calling @ref RegisterAutoControlPlugin().
     *
     * @param[in] index The ID of the sensor.
     ...
     *
     * @note Error notifications to the client are dropped until @ref EnableLink() is called.
     *
     * @param[in] index The ID of the sensor.
     *
     * @returns::SIPLStatus the completion status of the operation.
     ...
     * @pre This function should only be called after @ref Start() and before @ref Stop().
     *
     * @note Error notifications to the client that were disabled by @ref DisableLink() are resumed.
     *
     * @param[in] index The ID of the sensor.
     ...
     *
     * This method updates the input @ref NvSciSyncAttrList with values equivalent to the
     * following public attribute key-values:
     * @ref NvSciSyncAttrKey_RequiredPerm set to
     * - @ref NvSciSyncAccessPerm_WaitOnly for @ref clientType SIPL_WAITER
     * - @ref NvSciSyncAccessPerm_SignalOnly for @ref clientType SIPL_SIGNALER
     * @ref NvSciSyncAttrKey_PrimitiveInfo set to
     * - @ref NvSciSyncAttrValPrimitiveType_Syncpoint
     *
     * This interfaces updates the input NvSciBufAttrList with values equivalent to the following
     * public attribute key-values:
     * @ref NvSciSyncAttrKey_PeerHwEngineArray set to following @ref NvSciBufPeerHwEngine value only for
     * OutputType ICP.
     * -  @ref NvSciBufHwEngName set to @ref NvSciBufHwEngName_Vi
     * -  @ref NvSciBufPlatformName set to @ref NvSciBufPlatformName_Orin
     *
     * @pre This function must be called
     * - after @ref SetPipelineCfg on Tegra platforms
     * - after @ref Init() on x86 platforms
     * and before @ref RegisterNvSciSyncObj().
     *
     * @param[in] index The ID of the sensor.
     ...
     *   - De-Init: No
     */
    virtual SIPLStatus FillNvSciSyncAttrList(uint32_t const index,
                                             INvSIPLClient::ConsumerDesc::OutputType const outType,
     ...
     * @param[in] syncobjtype Presync or EOF sync
     ...
     *   - De-Init: No
     */
    virtual SIPLStatus RegisterNvSciSyncObj(uint32_t const index,
                                            INvSIPLClient::ConsumerDesc::OutputType const outType,
