...
{
    /** Number of ROIs */
    /** Single ROI should give best perf for pyramid SGM Mode */
    uint32_t                numOfROIs;
...
typedef struct
{
     ...
     * \n One of the value from @ref NvMediaIofaEpiSearchRange
     */
...
typedef struct
{
     ...
     * \n <b> Epipolar Optical Flow Processing: </b> An input NvSciBufObj containing input frame.
     ...
     * \n <b> Epipolar Optical Flow Processing: </b> An input NvSciBufObj containing reference frame.
     * \n It must be have the same width and height as provided in @ref NvMediaIofaInitParams
     * \n In case of Pyramid Optical Flow Processing: Resolution of higher levels should also
     *    be the same as provided in @ref NvMediaIofa Object
     ...
     * \n <b> Epipolar Optical Flow Processing: </b> Not Applicable
 ...
 *      Note: HW will generate output for ROI region only and Single ROI should give best perf for pyramid SGM Mode.
