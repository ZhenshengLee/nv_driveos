...
/**
 * @brief Specifies the capture interface type for the CSI interface.
 */
typedef enum {
...
/**
 * @brief Specifies the capture input format type.
 */
typedef enum {
...
/** @brief NVSIPL_PIXEL_ORDER flags. */
...
/** @brief PIXEL_ORDER flags for RGBA surface type. */
...
/** @brief PIXEL_ORDER flags for RAW surface type. */
...
/** @brief PIXEL_ORDER flags for RAW RGB-IR surface type. */
