...
NVERROR(Disconnected,                       0x00000012, "Communication resource disconnected")
NVERROR(InterruptedBySignal,                0x00000013, "Interrupted by signal")

/* HOS Error Codes */
NVERROR(InsufficientTransferMemory,         0x00001000, "insufficient transfer memory")
...
/* UFS error codes */
NVERROR(UfsCommandFailed,                   0x00048000,  "UFS command failed")
...
NVERROR(VideoDecVPRMemoryAllocFail,            0x000E3802, "Video Decoder VPR memory Allocation failed")
NVERROR(VideoDecVPRMemoryAccessFail,           0x000E3803, "Video Decoder VPR memory Access failed")
...
/* Android Verified Boot Flow Error Codes */
NVERROR(ValidationError,                   0x00410000, "Signature validation failed")
NVERROR(DataFlushed,                       0x00410001, "Write-protected data overwritten")
NVERROR(DataLengthOverflow,                0x00410002, "Length doesn't fit in type size_t")
NVERROR(CorruptImage,                      0x00410003, "Corrupt image")

/* PVA error codes */
NVERROR(PVAEngineBadState,                 0x00420000, "PVA engine in bad state")
NVERROR(PVAKMDBuffPinSlotsExceeded,        0x00420001, "PVA KMD does not have any free slots for buffer pinning")
NVERROR(PVAKMDBuffPinFailInMemService,     0x00420002, "PVA KMD encountered a failure in memory service while pinning the buffers")
NVERROR(PVAVPUAuthFailed,                  0x00420003, "PVA encountered a failure in authenticating VPU executable")

/* DLA error codes [0x00430000 - 0x0043FFFF] */
NVERROR(DLAInsufficientLocalDRAM,          0x00430001, "Configured local dram insufficient for compilation")
NVERROR(DLAInsufficientGlobalDRAM,         0x00430002, "Configured global dram insufficient for compilation")
NVERROR(DLALoadableVersionMismatch,        0x00430003, "DLA Loadable version mismatch")
NVERROR(DLARuntimeVersionMismatch,         0x00430004, "DLA Runtime version mismatch")
NVERROR(DLAFirmwareVersionMismatch,        0x00430005, "DLA Firmware version mismatch")
NVERROR(DLAHardwareVersionMismatch,        0x00430006, "DLA Hardware version mismatch")
NVERROR(DLAEmulatorVersionMismatch,        0x00430007, "DLA Emulator version mismatch")

/* nvrm_gpu / nvrm_gpu_sc error codes (non-fatal) */
NVERROR(GpuInvalidHandle,                  0x00440000, "Invalid handle")
NVERROR(GpuHwError,                        0x00440001, "Hardware error")
NVERROR(GpuOutOfOrderFree,                 0x00440002, "Freeing dependent object before dependencies")
NVERROR(GpuInvalidDvmsState,               0x00440003, "API call not available due to DVMS state")

/* nvrm_gpu / nvrm_gpu_sc error codes (fatal) */
NVERROR(GpuFatalLockdown,                  0x00441000, "Lockdown in effect due to a previous fatal error")
NVERROR(GpuFatalConsistencyError,          0x00441001, "State consistency error")
NVERROR(GpuFatalLogicError,                0x00441002, "Internal logic error")
NVERROR(GpuFatalOsError,                   0x00441003, "Fatal OS error")
NVERROR(GpuFatalUncheckedException,        0x00441004, "Unchecked exception encountered")
NVERROR(GpuFatalOutOfOrderFree,            0x00441005, "Cannot free: reference count > 0")
