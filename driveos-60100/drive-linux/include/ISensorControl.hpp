...
/**
 * @brief Interface defining basic Sensor Control functionality
 */
...
public:
     ...
     *
     * @pre
     *   - A valid sensor device driver created with @ref DriverCreate().
     *   - Sensor device driver implements @ref ParseTopEmbDataInfo() function.
     *
     ...
     *                                          Valid size is device specific.
     *
     * @retval          NVMEDIA_STATUS_OK      On successful operation.
     * @retval          (NvMediaStatus)        On other sub-routine propagated error.
     *
     * @usage
     ...
     * @pre
     *   - A valid sensor device driver created with @ref DriverCreate().
     *   - Sensor device driver implements @ref ParseBotEmbDataInfo() function.
     *
     ...
     * @pre
     *   - A valid sensor device driver created with @ref DriverCreate().
     *   - Sensor device driver implements @ref GetSensorAttributes() function.
     *
     ...
     *
     * This function calls into DevBlk CDI functionality to provide the ability for
     * the user to configure the sensor for characterization.
     ...
     * the input parameter @a expNo should be set to 'n'.
     * For a non-HDR sensor, the input parameter @a expNo should always be set to '1'.
     *
     * @note Exact API behavior is implementation defined.
     *
     * @pre
     *   - A valid sensor device driver created with @ref DriverCreate().
     *   - Sensor device driver implements @ref SetSensorCharMode() function.
     *
     * @param[in]  expNo  Sensor exposure number (of type @ref uint8_t) to be used for
     *                    characterization.
     *                    Valid range for @a expNo : [0, @ref DEVBLK_ISC_MAX_EXPOSURES - 1]
     ...
     *
     * This function calls into DevBlk CDI functionality to request authentication
     * of an image data. Pixel and embedded data can be authenticated.
     *
     ...
     *   - Sensor device driver implements @ref AuthenticateImage() function.
     *
