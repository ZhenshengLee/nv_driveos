...
14. Run inter-process unicast stream with a fixed producer-present rate at 100
    fps with features to reduce the context switch at runtime:
    - Enable sending payload synchronously at runtime
    - Disable NvSciIpc notification at runtime

    ./test_nvscistream_perf -p -f 10000 -r 100 -i -d &
    ./test_nvscistream_perf -c 0 -f 10000 -i -d
