                                    ...
                                    uint8_t *pDstBuf)
{
    ...
    const uint32_t srcBufSize = srcBufAttrs.size;
    ...
    const uint32_t srcPitch = srcBufAttrs.planePitches[0];
    ...
    const uint32_t dstBufSize = dstBufAttrs.size;
    sciErr = NvSciBufObjPutPixels(dstBufObj,
                                  nullptr,
                                  (const void **)(&pDstBufCpy),
                                  &dstBufSize,
                                  &dstBufAttrs.planePitches[0]);
