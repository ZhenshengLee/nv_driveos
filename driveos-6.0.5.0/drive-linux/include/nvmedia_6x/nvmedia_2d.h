...
///
#define NVMEDIA_2D_VERSION_MAJOR   7
...
/// @sa NvMedia2DGetVersion()
///
#define NVMEDIA_2D_VERSION_PATCH   1
...
typedef enum
{
    ...
    ///
    /// This mode results in 5-tap filtering being used.
    ///
    NVMEDIA_2D_FILTER_MEDIUM,

    /// @brief Highest quality filtering.
    ///
    /// This mode results in 10-tap filtering being used.
    ///
...
///
NvMediaStatus
NvMedia2DGetVersion(NvMediaVersion *version);
...
///
NvMediaStatus
NvMedia2DCreate(NvMedia2D **handle,
...
///
NvMediaStatus
NvMedia2DDestroy(NvMedia2D *handle);
...
/// The object will be initialised and ready to use. The caller takes ownership
...
///
NvMediaStatus
NvMedia2DGetComposeParameters(NvMedia2D * const handle,
...
///                                       pending. The caller should wait for
///                                       the least recently submitted
///                                       operation to complete and then try
///                                       again.
/// @retval NVMEDIA_STATUS_ERROR          An internal failure occurred when
...
///
NvMediaStatus
NvMedia2DCompose(NvMedia2D * const handle,
...
///
NvMediaStatus
NvMedia2DSetSrcGeometry(NvMedia2D * const handle,
                        NvMedia2DComposeParameters const params,
...
///
NvMediaStatus
NvMedia2DSetSrcFilter(NvMedia2D * const handle,
                      NvMedia2DComposeParameters const params,
                      uint32_t const index,
...
///
NvMediaStatus
NvMedia2DSetSrcBlendMode(NvMedia2D *const handle,
                         NvMedia2DComposeParameters const params,
                         uint32_t const index,
...
///
NvMediaStatus
NvMedia2DCreateFilterBuffer(NvMedia2D * const handle,
...
///
NvMediaStatus
NvMedia2DDestroyFilterBuffer(NvMedia2D * const handle,
                             NvMedia2DFilterBuffer const filterBuffer);
...
///
NvMediaStatus
NvMedia2DSetFilterBuffer(NvMedia2D * const handle,
                         NvMedia2DComposeParameters const params,
                         NvMedia2DFilterBuffer const filterBuffer);
...
///
NvMediaStatus
NvMedia2DComputeFilterCoefficients5Tap(NvMedia2D * const handle,
                                       NvMedia2DFilterBuffer const filterBuffer,
                                       uint32_t const index,
...
///
NvMediaStatus
NvMedia2DComputeFilterCoefficients10Tap(NvMedia2D * const handle,
                                        NvMedia2DFilterBuffer const filterBuffer,
                                        uint32_t const index,
