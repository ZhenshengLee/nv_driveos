...
#ifndef AR0820_B_3461_CUSTOMINTERFACE_HPP
#define AR0820_B_3461_CUSTOMINTERFACE_HPP
#include "INvSIPLDeviceInterfaceProvider.hpp"
#include "NvSIPLCommon.hpp"
#include "AR0820_B_3461_CustomData.h"

namespace nvsipl
{
// This is version 1 UUID obtained using https://www.uuidgenerator.net/
const UUID AR0820_B_3461_MAX9295_CUSTOM_INTERFACE_ID(0xb549dd36U, 0x3a02U, 0x11ebU, 0xadc1U,
                                                       0x02U, 0x42U, 0xacU, 0x12U, 0x00U, 0x02U);

/**
 * @brief The class of custom interfaces in Serializer max9295
 */
class AR0820_B_3461_MAX9295_CustomInterface : public Interface
{
public:
    /**
     ...
     *
     * @retval UUID AR0820_B_3461_MAX9295_CUSTOM_INTERFACE_ID
     */
    static const UUID& getClassInterfaceID(void) {return AR0820_B_3461_MAX9295_CUSTOM_INTERFACE_ID;}
    ...
    virtual const UUID& getInstanceInterfaceID(void) override {
                            return AR0820_B_3461_MAX9295_CUSTOM_INTERFACE_ID;}
...
/* coverity[misra_cpp_2008_rule_16_2_1_violation] : intentional TID-1391 */
    ...
    virtual SIPLStatus setDeserData(uint32_t deviceIndex, uint32_t registerNum, uint32_t dataLength, uint8_t *dataBuff) const = 0;
    virtual SIPLStatus getDeserData(uint32_t deviceIndex, uint32_t registerNum, uint32_t dataLength, uint8_t *dataBuff) const = 0;
    virtual SIPLStatus readRegisterMax9295 (const uint16_t registerAddr, const uint16_t dataLength, uint8_t *dataBuff) const = 0;
    virtual SIPLStatus writeRegisterMax9295(const uint16_t registerAddr, const uint16_t dataLength, const uint8_t *dataBuff) const = 0;
/* coverity[misra_cpp_2008_rule_16_2_1_violation] : intentional TID-1391 */
#endif
protected:
    virtual ~AR0820_B_3461_MAX9295_CustomInterface(void) {return;}
};


const UUID AR0820_B_3461_CUSTOM_INTERFACE_ID(0x4fc721b6U, 0x3481U, 0x11ebU, 0xadc1U,
                                                    0x02U, 0x42U, 0xacU, 0x12U, 0x00U, 0x02U);

/**
 * @brief The class of custom interfaces in Sensor AR0820
 */
class AR0820_B_3461_CustomInterface : public Interface
{
public:
    /**
     ...
     * the instance of the class
     *
     * @retval UUID AR0820_B_3461_CUSTOM_INTERFACE_ID
     */
    static const UUID& getClassInterfaceID(void) {return AR0820_B_3461_CUSTOM_INTERFACE_ID;}
    /**
     ...
     */
    /* coverity[misra_cpp_2008_rule_0_1_10_violation] : intentional TID-1966 */
    virtual const UUID& getInstanceInterfaceID(void) override {return AR0820_B_3461_CUSTOM_INTERFACE_ID;}
...
/* coverity[misra_cpp_2008_rule_16_2_1_violation] : intentional TID-1391 */
    ...
    virtual SIPLStatus readRegisterAR820 (const uint16_t registerAddr, uint16_t dataBuff[]) const = 0;
    virtual SIPLStatus writeRegisterAR820(const uint16_t registerAddr, const uint16_t dataBuff[]) const = 0;
/* coverity[misra_cpp_2008_rule_16_2_1_violation] : intentional TID-1391 */
#endif

protected:
    virtual ~AR0820_B_3461_CustomInterface(void) = default;
};

}
#endif //AR0820_B_3461_CUSTOMINTERFACE_HPP
