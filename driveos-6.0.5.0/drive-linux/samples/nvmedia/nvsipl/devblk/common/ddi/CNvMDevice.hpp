...
public:
    ...
    struct DriverContextImpl : public DriverContext {
         ...
         *   - De-Init: No
         */
        virtual void *GetPtr() override {return &m_Context;}

        /**
         * @brief Default destructor of struct DriverContextImpl.
         */
        virtual ~DriverContextImpl() = default;
    };
     ...
     *   - De-Init: Yes
     */
    virtual DevBlkCDIDevice* GetCDIDeviceHandle() const final;
     ...
     *   - De-Init: No
     */
    virtual uint8_t GetI2CAddr() const final;
     ...
     *   - De-Init: No
     */
    virtual uint8_t GetNativeI2CAddr() const final;
     ...
     *   - De-Init: No
     */
    virtual SIPLStatus CreateCDIDevice(DevBlkCDIRootDevice* const cdiRoot, const uint8_t linkIndex) final;
     ...
     *   - De-Init: No
     */
    virtual SIPLStatus Start() final;
     ...
     *   - De-Init: No
     */
    virtual SIPLStatus Reset() final;
