...
protected:
     ...
     *  .
     * - elif (m_eInputFormat.inputFormatType == NVSIPL_CAP_INPUT_FORMAT_TYPE_RGB888)
     *  - m_eInputFormat.bitsPerPixel = NVSIPL_BITS_PER_PIXEL_8
     *  .
     * - elif (m_eInputFormat.inputFormatType == NVSIPL_CAP_INPUT_FORMAT_TYPE_RAW8)
     *  - m_eInputFormat.bitsPerPixel = NVSIPL_BITS_PER_PIXEL_8
     *  .
     * - elif (m_eInputFormat.inputFormatType == NVSIPL_CAP_INPUT_FORMAT_TYPE_RAW10)
     *  - m_eInputFormat.bitsPerPixel = NVSIPL_BITS_PER_PIXEL_10
     *  .
     * - elif (m_eInputFormat.inputFormatType == NVSIPL_CAP_INPUT_FORMAT_TYPE_RAW12)
     *  - m_eInputFormat.bitsPerPixel = NVSIPL_BITS_PER_PIXEL_12
     *  .
     * - elif (m_eInputFormat.inputFormatType == NVSIPL_CAP_INPUT_FORMAT_TYPE_RAW16)
     *  - m_eInputFormat.bitsPerPixel = NVSIPL_BITS_PER_PIXEL_16
     *  .
     * - else
     *  - error exit  SIPL_LOG_ERR_STR_INT "Unknown input format"
     *  .
     *
     * @retval                      NVSIPL_STATUS_OK on completion
