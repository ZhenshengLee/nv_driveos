...
int main(int argc, char *argv[])
{
    ...
    if (srcWidth != dstWidth || srcHeight != dstHeight) {
        LOG_ERR("Different geometry for source and destination"
    ...
    NvMediaLdcParameters params;

    if (args.generateWarpMap || args.applyWarpMap) {
        pParamsAttrs->maxWarpMapWidth = dstWidth;
        pParamsAttrs->maxWarpMapHeight = dstHeight;
    }
