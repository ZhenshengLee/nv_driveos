...
SIPLStatus
CNvMMax20087::ReadRegister(DevBlkCDIDevice const * const handle, uint8_t
...
SIPLStatus
CNvMMax20087::WriteRegister(DevBlkCDIDevice const * const handle, uint8_t
              const linkIndex, uint32_t const registerNum, uint32_t const
              dataLength, uint8_t * const dataBuff)
{
    NvMediaStatus status = NVMEDIA_STATUS_OK;
