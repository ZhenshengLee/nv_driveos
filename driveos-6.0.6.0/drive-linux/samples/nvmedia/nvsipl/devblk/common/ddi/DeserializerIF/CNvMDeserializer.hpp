...
public:
    ...
    /**
     * Defines Recorder configuration
     */
    enum CamRecMode {
        /**
        ...
        CAM_REC_MODE_NONE,
        /**
         * Enable Recorder support with the samtect cable version 1
         */
        CAM_REC_MODE_VER1,
        /**
         * Enable Recorder support with the samtect cable version 2
         */
        CAM_REC_MODE_VER2_A01B23,
        /**
         * Enable Recorder support for first 2 cameras with the samtect cable version 2
         */
        CAM_REC_MODE_VER2_A01,
        /**
         * Enable Recorder support for second 2 cameras with the samtect cable version 2
         */
        CAM_REC_MODE_VER2_B23,
    };
     ...
     *   - De-Init: No
     */
    virtual SIPLStatus SetConfig(const DeserInfo *const siplDeserInfo, DeserializerParams *const params) final;
     ...
     *   - De-Init: No
     */
    virtual SIPLStatus SetPower(const bool powerOn) final;
...
protected:
    ...
    /*
     * Holds the recorder configuration
     */
    CamRecMode m_camRecCfg = CAM_REC_MODE_NONE;
