...
std::unique_ptr<CNvMSerializer> CNvMMAX96712_96717CameraModule::CreateNewSerializer() {
    return std::unique_ptr<CNvMSerializer>(new CNvMMax96717F());
}

std::unique_ptr<CNvMTransportLink> CNvMMAX96712_96717CameraModule::CreateNewTransportLink() {
    return std::unique_ptr<CNvMTransportLink>(new CNvMTransportLink_Max96712_96717());
}

CNvMDeserializer::LinkMode CNvMMAX96712_96717CameraModule::GetLinkMode() {
    return CNvMDeserializer::LinkMode::LINK_MODE_GMSL2_6GBPS;
}

Interface* CNvMMAX96712_96717CameraModule::GetInterface(const UUID &interfaceId) {
    return nullptr;
}
