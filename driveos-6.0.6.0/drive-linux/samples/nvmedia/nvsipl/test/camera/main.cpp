...
int main(int argc, char *argv[])
{
    ...
    if (!cmdline.vInputRawFiles.empty()) {
        ...
        oPlatformCfg.deviceBlockList[0].isSimulatorModeEnabled = true; //Bug 3598247: remove in 6.0.7
    ...
    if (cmdline.bTwoPassIsp) {
        ...
        oPlatformCfg.deviceBlockList[uSimulatorDevBlk].isSimulatorModeEnabled = true; //Bug 3598247: remove in 6.0.7
    ...
    for (auto d = 0u; d != oPlatformCfg.numDeviceBlocks; d++) {
        ...
        for (auto m = 0u; m != db.numCameraModules; m++) {
            ...
            if (db.isSimulatorModeEnabled && db.cameraModuleInfoList[m].isSimulatorModeEnabled) {
