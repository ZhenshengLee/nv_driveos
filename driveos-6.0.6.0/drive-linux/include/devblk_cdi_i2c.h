 ...
 *                  Valid range: [>0].
 * @param[in]   commit A flag indicating whether i2cProgrammer believes the i2c WR
 *                     transactions shall be "committed". Exact meaning of this flag
 *                     depends on implementation of an i2c WR listener.
 *                     i2cProgrammer sets this flag in case:
 *                      - it finished sending a "block" of related i2c write transactions
 *                        from a register table (see DevBlkCDII2CPgmrWriteArray).
 *                      - sleep will be performed by i2cProgrammer right after listeners
 *                        are notified.
 *                      - i2cProgrammer performed a WR into "address space remapping"
 *                        register.
