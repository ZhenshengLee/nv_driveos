 ...
 * \implements{18840180}
 */
static const uint32_t NvSciSyncMinorVersion = 5U;
 ...
 * \return void
 * - Panics if:
 *   - if Init Mode API check fails i.e. nvscicommon_dvms_check_init_api()
 *     returns NvSciError_InvalidState.
 *   - @a module is invalid
 *
 * @pre
 ...
 * \return void
 * - Panics if:
 *   - Init Mode API check fails i.e. nvscicommon_dvms_check_init_api()
 *     returns NvSciError_InvalidState.
 ...
 *  is not valid
 * - Panics if if Init Mode API check fails i.e. nvscicommon_dvms_check_init_api()
 *   returns NvSciError_InvalidState.
 *
 * @pre
 * - Valid NvSciSyncAttrList is obtained.
 ...
 * \return void
 * - Panics if Init Mode API check fails i.e. nvscicommon_dvms_check_init_api()
 *   returns NvSciError_InvalidState.
 *
 * @pre
