...
struct NvSIPLDownscaleCropCfg
{
     ...
     * Vertical cropped size (bottom - top) should be even number.
    */
     ...
     * and cropped width and height must be even.
     * Crop left should be within [0, image width-2].
     * Crop right should be within [2, image width].
     * Crop top should be within [0, image height-2].
     * Crop bot should be within [2, image heigh].
     */
     ...
     * Crop right should be within [2, image width].
     * Crop top should be within [0, image height-2].
     * Crop bot should be within [2, image height].
    */
